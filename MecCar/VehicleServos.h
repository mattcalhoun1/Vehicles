...
#ifndef VEHICLE_SERVOS_H
#define VEHICLE_SERVOS_H

#define VEHICLE_SERVOS_PCA_ADDRESS 0x40 // 0x40 or 0x70
...
class VehicleServos {
  ...
  private:
    Adafruit_PWMServoDriver servoDriver = Adafruit_PWMServoDriver(VEHICLE_SERVOS_PCA_ADDRESS, Wire1);
